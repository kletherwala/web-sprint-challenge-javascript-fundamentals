...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// when a function is declared it creates its own scope and functions look outward for context. If a variable isnt defined in the functions scope then it will look outside for it. in this example the nestedFunction is inside of my function and has access to the variable internal.
...
// });
  ...
  */
  ...
  //   return a + b; 
  // }
//  console.log('step1:', consume(1, 2, cb)); 
...
console.log('step2 multiply', multiply(5, 5));
...
function greeting(first, last, consumecb){
  ...
  console.log('step2 greeting', greeting('kiran', 'letherwala'));
